...
$string['notificationemail_help'] = 'Enter an email address to be notified when a certificate is issued to a student.';
$string['certificateissued'] = 'Certificate {$a->certificatename} was awarded to {$a->firstname} {$a->lastname}';
$string['notificationemail_info'] = 'Enter an email address to be notified when a certificate is issued to a student. Please note that this only works when used inside a certificate activity. Issuing certificates manually will not send an email.';
